...
Pod::Spec.new do |s|
  s.name             = 'AVVPNService'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AVVPNService.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'AndreVasilev' => 'ao.vasilev@gmail.com' }
  s.source           = { :git => 'https://github.com/AndreVasilev/AVVPNService.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'AVVPNService/Classes/**/*'
  
  # s.resource_bundles = {
  #   'AVVPNService' => ['AVVPNService/Assets/*.png']
  # }
